...
- If you add a new feature, go to the roadmap.md file. If the feature is in the roadmap part, remove it from there. Add this new feature to the Release Notes, first the date, then the feature list. Keep the release notes concise and targeted to end users of the app. For bug fixes, start it with "BUG FIX:"
