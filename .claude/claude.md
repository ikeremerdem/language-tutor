...
- If you add a new feature, go to the roadmap.md file. If the feature is in the roadmap part, remove it from there. Add this new feature to the Release Notes section, first the date, then the feature
