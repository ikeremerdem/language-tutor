...
export default function StatsChart({ data }: Props) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6">
      <h3 className="text-lg font-semibold text-filos-primary mb-4 font-headline">Weekly Activity</h3>
      {data.every((d) => d.sessions === 0) ? (
        ...
        <ResponsiveContainer width="100%" height={260}>
          <BarChart data={formatted}>
            ...
            />
            <Bar yAxisId="left" dataKey="questions" fill="#004688" name="Questions" radius={[6, 6, 0, 0]} />
